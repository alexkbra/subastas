...
export class MensajesComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.mensajesService
      ...
      .subscribe(
        (res: HttpResponse<IMensajes[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  trackId(index: number, item: IMensajes): number {
  ...
  registerChangeInMensajes(): void {
    this.eventSubscriber = this.eventManager.subscribe('mensajesListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IMensajes[] | null, headers: HttpHeaders, page: number): void {
