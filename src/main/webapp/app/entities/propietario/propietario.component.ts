...
export class PropietarioComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.propietarioService
      ...
      .subscribe(
        (res: HttpResponse<IPropietario[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  registerChangeInPropietarios(): void {
    this.eventSubscriber = this.eventManager.subscribe('propietarioListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IPropietario[] | null, headers: HttpHeaders, page: number): void {
