...
export class LotesComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.lotesService
      ...
      .subscribe(
        (res: HttpResponse<ILotes[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  registerChangeInLotes(): void {
    this.eventSubscriber = this.eventManager.subscribe('lotesListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: ILotes[] | null, headers: HttpHeaders, page: number): void {
