...
import { AnimalesComponent } from 'app/entities/animales/animales.component';
...
describe('Component Tests', () => {
  describe('Animales Management Component', () => {
    let comp: AnimalesComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AnimalesComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.animales && comp.animales[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
