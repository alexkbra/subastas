...
import { EstadoClienteComponent } from 'app/entities/estado-cliente/estado-cliente.component';
...
describe('Component Tests', () => {
  describe('EstadoCliente Management Component', () => {
    let comp: EstadoClienteComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(EstadoClienteComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.estadoClientes && comp.estadoClientes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
