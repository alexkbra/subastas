...
import { RazasComponent } from 'app/entities/razas/razas.component';
import { RazasService } from 'app/entities/razas/razas.service';
import { Razas } from 'app/shared/model/razas.model';

describe('Component Tests', () => {
  describe('Razas Management Component', () => {
    let comp: RazasComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(RazasComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.razas && comp.razas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
