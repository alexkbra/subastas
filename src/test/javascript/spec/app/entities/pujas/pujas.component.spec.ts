...
import { PujasComponent } from 'app/entities/pujas/pujas.component';
import { PujasService } from 'app/entities/pujas/pujas.service';
import { Pujas } from 'app/shared/model/pujas.model';

describe('Component Tests', () => {
  describe('Pujas Management Component', () => {
    let comp: PujasComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(PujasComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.pujas && comp.pujas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
