...
import { EspeciesComponent } from 'app/entities/especies/especies.component';
...
describe('Component Tests', () => {
  describe('Especies Management Component', () => {
    let comp: EspeciesComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(EspeciesComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.especies && comp.especies[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
