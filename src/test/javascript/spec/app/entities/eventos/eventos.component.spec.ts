...
import { EventosComponent } from 'app/entities/eventos/eventos.component';
...
describe('Component Tests', () => {
  describe('Eventos Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.eventos && comp.eventos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
